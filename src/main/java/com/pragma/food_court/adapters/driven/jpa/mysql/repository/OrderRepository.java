...
@Query("SELECT o FROM OrderEntity o WHERE o.restaurantId = :restaurantId")
Page<OrderEntity> findAllByClientId(@Param("restaurantId") Long restaurantId, Pageable pageable);
